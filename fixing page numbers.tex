...
%does this work?
%yh all good i think
%Why are we on 16 now? Is fig 19 a bit big
% recompile? i have 15 pages
%ah great
%nice one
%can we give the equations a little more room? Or will it fuck things up
%we have a little space at the end
% thing is we kinda want the risk assesment on one page tho but i will have a look
%Ok that works. This is a surprisingly good communication method. Maybe risk assess is more important, whatever you think.
\vspace{-25pt}
...
\begin{figure}[H]
    \centering
        \includegraphics[width=1\linewidth]{GANTT EDITED BY LOUIS.png} % Replace with your Blender animation image
...
\bibitem{Vehicle_Dynamics_And_Control} Wuwei Chen et al. (2016) Integrated vehicle dynamics and control. John Wiley \& Sons Inc.2016, Page 23.
